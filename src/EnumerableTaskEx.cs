...
public static class EnumerableTaskEx
{
	...
	public static async Task<IEnumerable<TResult>> SelectEnumerable<TSource, TResult>(this Task<IEnumerable<TSource>> @this, Func<IEnumerable<TSource>, IEnumerable<TResult>> enumerableSelector)
	{
		var items = await @this.ConfigureAwait(false);
		return enumerableSelector(items);
	}
